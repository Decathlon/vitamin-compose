    ...
    get() {
        ...
        _camera = Builder(name = "Camera", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(14.0f, 18.0f)
                curveTo(15.3261f, 18.0f, 16.5979f, 17.4732f, 17.5356f, 16.5355f)
                curveTo(18.4732f, 15.5979f, 19.0f, 14.3261f, 19.0f, 13.0f)
                curveTo(19.0f, 11.6739f, 18.4732f, 10.4021f, 17.5356f, 9.4645f)
                curveTo(16.5979f, 8.5268f, 15.3261f, 8.0f, 14.0f, 8.0f)
                curveTo(12.6739f, 8.0f, 11.4022f, 8.5268f, 10.4645f, 9.4645f)
                curveTo(9.5268f, 10.4021f, 9.0f, 11.6739f, 9.0f, 13.0f)
                curveTo(9.0f, 14.3261f, 9.5268f, 15.5979f, 10.4645f, 16.5355f)
                curveTo(11.4022f, 17.4732f, 12.6739f, 18.0f, 14.0f, 18.0f)
                close()
                moveTo(4.0f, 7.0f)
                verticalLineTo(9.0f)
