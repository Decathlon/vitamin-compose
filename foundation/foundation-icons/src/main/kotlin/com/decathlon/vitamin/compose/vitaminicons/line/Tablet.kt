...
public val LineGroup.Tablet: ImageVector
    get() {
        if (_tablet != null) {
            return _tablet!!
        }
        _tablet = Builder(name = "Tablet", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(8.1768f, 11.3333f, 8.3463f, 11.4036f, 8.4714f, 11.5286f)
                    curveTo(8.5964f, 11.6536f, 8.6666f, 11.8232f, 8.6666f, 12.0f)
                    curveTo(8.6666f, 12.1768f, 8.5964f, 12.3464f, 8.4714f, 12.4714f)
                    curveTo(8.3463f, 12.5964f, 8.1768f, 12.6667f, 8.0f, 12.6667f)
                    curveTo(7.8232f, 12.6667f, 7.6536f, 12.5964f, 7.5286f, 12.4714f)
                    curveTo(7.4035f, 12.3464f, 7.3333f, 12.1768f, 7.3333f, 12.0f)
                    curveTo(7.3333f, 11.8232f, 7.4035f, 11.6536f, 7.5286f, 11.5286f)
                    curveTo(7.6536f, 11.4036f, 7.8232f, 11.3333f, 8.0f, 11.3333f)
                    close()
                }
            }
        }
