    ...
    get() {
        ...
        _emotion = Builder(name = "Emotion", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(5.3334f, 8.6667f)
                curveTo(5.3334f, 9.374f, 5.6143f, 10.0522f, 6.1144f, 10.5523f)
                curveTo(6.6145f, 11.0524f, 7.2928f, 11.3334f, 8.0f, 11.3334f)
                curveTo(8.7073f, 11.3334f, 9.3856f, 11.0524f, 9.8857f, 10.5523f)
                curveTo(10.3858f, 10.0522f, 10.6667f, 9.374f, 10.6667f, 8.6667f)
