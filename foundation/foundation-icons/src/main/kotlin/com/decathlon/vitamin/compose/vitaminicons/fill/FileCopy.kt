    ...
    get() {
        ...
        _fileCopy = Builder(name = "FileCopy", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(17.0f, 21.552f, 16.5498f, 22.0f, 15.9932f, 22.0f)
                horizontalLineTo(4.0068f)
                curveTo(3.875f, 22.0007f, 3.7446f, 21.9755f, 3.6226f, 21.9257f)
                curveTo(3.5747f, 21.9061f, 3.5288f, 21.8829f, 3.4844f, 21.8564f)
                curveTo(3.416f, 21.8152f, 3.3525f, 21.7659f, 3.2959f, 21.7094f)
                curveTo(3.272f, 21.6857f, 3.2495f, 21.6609f, 3.228f, 21.6351f)
                curveTo(3.166f, 21.5594f, 3.1152f, 21.4749f, 3.0772f, 21.3842f)
                curveTo(3.0264f, 21.2625f, 3.0f, 21.1318f, 3.0f, 21.0f)
                lineTo(3.0029f, 7.0f)
                curveTo(3.0029f, 6.448f, 3.4531f, 6.0f, 4.0098f, 6.0f)
                close()
            }
        }
        .build()
