    ...
    get() {
        ...
        _tempCold = Builder(name = "TempCold", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(16.0f, 17.0609f, 15.5786f, 18.0783f, 14.8284f, 18.8284f)
                curveTo(14.0783f, 19.5786f, 13.0609f, 20.0f, 12.0f, 20.0f)
                curveTo(10.9391f, 20.0f, 9.9217f, 19.5786f, 9.1716f, 18.8284f)
                curveTo(8.4214f, 18.0783f, 8.0f, 17.0609f, 8.0f, 16.0f)
                close()
            }
        }
        .build()
