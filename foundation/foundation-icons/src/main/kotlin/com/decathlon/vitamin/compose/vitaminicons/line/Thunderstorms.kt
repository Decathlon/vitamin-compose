    ...
    get() {
        ...
        _thunderstorms = Builder(name = "Thunderstorms", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.0771f, 15.9999f, 18.6451f, 15.8571f, 19.1537f, 15.5844f)
                curveTo(19.6622f, 15.3117f, 20.0954f, 14.9175f, 20.4147f, 14.4369f)
                curveTo(20.7341f, 13.9562f, 20.9296f, 13.4041f, 20.984f, 12.8296f)
                curveTo(21.0383f, 12.2552f, 20.9498f, 11.6762f, 20.7263f, 11.1442f)
                curveTo(20.5028f, 10.6122f, 20.1512f, 10.1437f, 19.7028f, 9.7805f)
                curveTo(19.2545f, 9.4172f, 18.7232f, 9.1705f, 18.1565f, 9.0622f)
                curveTo(17.5897f, 8.9538f, 17.0049f, 8.9874f, 16.4542f, 9.1597f)
                curveTo(15.9035f, 9.332f, 15.404f, 9.6379f, 15.0f, 10.05f)
                verticalLineTo(10.0f)
                curveTo(14.9996f, 8.9001f, 14.6969f, 7.8214f, 14.1249f, 6.8819f)
                curveTo(13.553f, 5.9425f, 12.7337f, 5.1783f, 11.7568f, 4.6729f)
                curveTo(10.7799f, 4.1676f, 9.6828f, 3.9405f, 8.5856f, 4.0164f)
                curveTo(7.4883f, 4.0924f, 6.433f, 4.4686f, 5.5351f, 5.1037f)
                curveTo(4.6371f, 5.7389f, 3.931f, 6.6087f, 3.494f, 7.6181f)
                curveTo(3.057f, 8.6274f, 2.9058f, 9.7375f, 3.057f, 10.8269f)
                curveTo(3.2082f, 11.9164f, 3.656f, 12.9433f, 4.3514f, 13.7955f)
                curveTo(5.0468f, 14.6477f, 5.963f, 15.2923f, 7.0f, 15.659f)
