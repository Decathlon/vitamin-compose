    ...
    get() {
        ...
        _link = Builder(name = "Link", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(18.8316f, 12.2425f, 19.2031f, 11.6911f, 19.4571f, 11.0836f)
                curveTo(19.7111f, 10.4761f, 19.8425f, 9.8244f, 19.844f, 9.166f)
                curveTo(19.8454f, 8.5075f, 19.7168f, 7.8553f, 19.4655f, 7.2467f)
                curveTo(19.2142f, 6.6381f, 18.8451f, 6.0851f, 18.3795f, 5.6195f)
                curveTo(17.9139f, 5.1539f, 17.361f, 4.7848f, 16.7524f, 4.5335f)
                ...
                curveTo(2.9082f, 18.4652f, 2.1707f, 16.6846f, 2.1707f, 14.828f)
                curveTo(2.1707f, 12.9714f, 2.9082f, 11.1908f, 4.221f, 9.878f)
                lineTo(5.636f, 8.464f)
                lineTo(7.05f, 9.88f)
                lineTo(5.636f, 11.294f)
                curveTo(5.1684f, 11.7576f, 4.7969f, 12.3089f, 4.5429f, 12.9164f)
                curveTo(4.289f, 13.5239f, 4.1575f, 14.1756f, 4.156f, 14.834f)
                curveTo(4.1546f, 15.4925f, 4.2832f, 16.1447f, 4.5345f, 16.7533f)
                curveTo(4.7859f, 17.362f, 5.1549f, 17.9149f, 5.6205f, 18.3805f)
                curveTo(6.0861f, 18.8461f, 6.6391f, 19.2152f, 7.2477f, 19.4665f)
                curveTo(7.8563f, 19.7178f, 8.5085f, 19.8464f, 9.167f, 19.845f)
                curveTo(9.8254f, 19.8435f, 10.4771f, 19.7121f, 11.0846f, 19.4581f)
                curveTo(11.6921f, 19.2041f, 12.2435f, 18.8326f, 12.707f, 18.365f)
