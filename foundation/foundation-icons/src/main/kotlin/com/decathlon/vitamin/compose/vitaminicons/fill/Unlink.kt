    ...
    get() {
        ...
        _unlink = Builder(name = "Unlink", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(13.1407f, 6.9841f, 13.2284f, 6.5496f, 13.2294f, 6.1106f)
                ...
                curveTo(10.7625f, 2.8548f, 10.3277f, 2.769f, 9.8887f, 2.77f)
                ...
                curveTo(11.1244f, 1.4478f, 12.3115f, 1.9395f, 13.1867f, 2.8147f)
                curveTo(14.0619f, 3.6899f, 14.5536f, 4.8769f, 14.5536f, 6.1147f)
                curveTo(14.5536f, 7.3524f, 14.0619f, 8.5394f, 13.1867f, 9.4147f)
                lineTo(12.2434f, 10.3573f)
                horizontalLineTo(12.2427f)
                close()
                moveTo(10.3574f, 12.2427f)
                lineTo(9.414f, 13.1853f)
                curveTo(8.5388f, 14.0605f, 7.3518f, 14.5522f, 6.114f, 14.5522f)
                curveTo(4.8763f, 14.5522f, 3.6893f, 14.0605f, 2.814f, 13.1853f)
                curveTo(1.9388f, 12.3101f, 1.4471f, 11.1231f, 1.4471f, 9.8853f)
                curveTo(1.4471f, 8.6476f, 1.9388f, 7.4605f, 2.814f, 6.5853f)
                lineTo(3.7574f, 5.6427f)
                lineTo(4.7f, 6.5867f)
                lineTo(3.7574f, 7.5293f)
                curveTo(3.4456f, 7.8384f, 3.198f, 8.2059f, 3.0287f, 8.6109f)
                curveTo(2.8593f, 9.0159f, 2.7717f, 9.4504f, 2.7707f, 9.8893f)
                curveTo(2.7698f, 10.3283f, 2.8555f, 10.7632f, 3.0231f, 11.1689f)
                curveTo(3.1906f, 11.5746f, 3.4366f, 11.9433f, 3.747f, 12.2537f)
                curveTo(4.0574f, 12.5641f, 4.4261f, 12.8101f, 4.8318f, 12.9776f)
                curveTo(5.2375f, 13.1452f, 5.6724f, 13.2309f, 6.1114f, 13.23f)
                curveTo(6.5503f, 13.229f, 6.9848f, 13.1414f, 7.3898f, 12.972f)
                curveTo(7.7948f, 12.8027f, 8.1623f, 12.5551f, 8.4714f, 12.2433f)
                lineTo(9.414f, 11.3007f)
