...
public val LineGroup.EmotionUnhappy: ImageVector
    get() {
        ...
        _emotionUnhappy = Builder(name = "EmotionUnhappy", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(8.0f, 8.0f)
                curveTo(6.159f, 8.0f, 4.6666f, 9.4924f, 4.6666f, 11.3334f)
                horizontalLineTo(6.0f)
                curveTo(6.0f, 10.2288f, 6.8954f, 9.3334f, 8.0f, 9.3334f)
                curveTo(9.1046f, 9.3334f, 10.0f, 10.2288f, 10.0f, 11.3334f)
                horizontalLineTo(11.3333f)
                curveTo(11.3333f, 9.4924f, 9.8409f, 8.0f, 8.0f, 8.0f)
                close()
