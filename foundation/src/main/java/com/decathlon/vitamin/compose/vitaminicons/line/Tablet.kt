        ...
        _tablet = Builder(name = "Tablet", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            group {
                path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    close()
                    moveTo(12.0f, 17.0f)
                    curveTo(12.2652f, 17.0f, 12.5196f, 17.1054f, 12.7071f, 17.2929f)
                    curveTo(12.8946f, 17.4804f, 13.0f, 17.7348f, 13.0f, 18.0f)
                    curveTo(13.0f, 18.2652f, 12.8946f, 18.5196f, 12.7071f, 18.7071f)
                    curveTo(12.5196f, 18.8946f, 12.2652f, 19.0f, 12.0f, 19.0f)
                    curveTo(11.7348f, 19.0f, 11.4804f, 18.8946f, 11.2929f, 18.7071f)
                    curveTo(11.1054f, 18.5196f, 11.0f, 18.2652f, 11.0f, 18.0f)
                    curveTo(11.0f, 17.7348f, 11.1054f, 17.4804f, 11.2929f, 17.2929f)
                    curveTo(11.4804f, 17.1054f, 11.7348f, 17.0f, 12.0f, 17.0f)
                    close()
                }
            }
        }
