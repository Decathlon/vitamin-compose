    ...
    get() {
        ...
        _scales = Builder(name = "Scales", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(18.0f, 9.103f)
                lineTo(16.042f, 14.489f)
                curveTo(16.629f, 14.82f, 17.299f, 15.0f, 18.0f, 15.0f)
                curveTo(18.7f, 15.0f, 19.37f, 14.82f, 19.958f, 14.49f)
                lineTo(18.0f, 9.102f)
                verticalLineTo(9.103f)
                close()
                moveTo(6.0f, 9.103f)
                lineTo(4.042f, 14.489f)
                curveTo(4.629f, 14.82f, 5.299f, 15.0f, 6.0f, 15.0f)
                curveTo(6.7f, 15.0f, 7.37f, 14.82f, 7.958f, 14.49f)
                lineTo(6.0f, 9.102f)
                verticalLineTo(9.103f)
                close()
            }
