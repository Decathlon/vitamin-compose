    ...
    get() {
        ...
        _bodyScan = Builder(name = "BodyScan", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(7.5f, 7.0f)
                curveTo(7.5f, 8.1935f, 7.9741f, 9.3381f, 8.818f, 10.182f)
                curveTo(9.6619f, 11.0259f, 10.8065f, 11.5f, 12.0f, 11.5f)
                curveTo(13.1935f, 11.5f, 14.3381f, 11.0259f, 15.182f, 10.182f)
                curveTo(16.0259f, 9.3381f, 16.5f, 8.1935f, 16.5f, 7.0f)
