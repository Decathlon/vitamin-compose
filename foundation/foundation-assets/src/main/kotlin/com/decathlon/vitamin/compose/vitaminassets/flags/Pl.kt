...
public val FlagsGroup.Pl: ImageVector
    get() {
        if (_pl != null) {
            return _pl!!
        }
        _pl = Builder(name = "Pl", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFFEB2A50)), stroke = null, strokeLineWidth = 0.0f,
