    ...
    get() {
        ...
        _tk = Builder(name = "Tk", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = linearGradient(0.0f to Color(0xFFFDD33F), 1.0f to Color(0xFFFED02F),
                        start = Offset(14.6669f,2.66667f), end = Offset(14.6669f,17.3333f)), stroke
                    ...
                    curveTo(19.3336f, 5.3333f, 24.0002f, 2.6667f, 24.0002f, 2.6667f)
                    curveTo(24.0002f, 2.6667f, 21.81f, 6.7646f, 22.0002f, 8.6667f)
                    curveTo(22.2545f, 11.209f, 25.3336f, 14.6667f, 25.3336f, 14.6667f)
                    horizontalLineTo(6.6669f)
                    curveTo(6.6669f, 14.6667f, 11.3336f, 10.6667f, 15.3336f, 8.0f)
                    close()
                }
