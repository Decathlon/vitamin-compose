        ...
        _cas = Builder(name = "Cas", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFFffffff)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(7.4001f, 11.1998f, 7.1999f, 11.2666f, 7.0352f, 11.1843f)
                    lineTo(6.0704f, 10.7018f)
                    curveTo(6.0241f, 10.6787f, 5.9731f, 10.6667f, 5.9213f, 10.6667f)
                    horizontalLineTo(4.3333f)
                    curveTo(4.1492f, 10.6667f, 4.0f, 10.8159f, 4.0f, 11.0f)
                    verticalLineTo(11.7597f)
                    curveTo(4.0f, 11.9032f, 4.0918f, 12.0306f, 4.2279f, 12.076f)
                    lineTo(5.4883f, 12.4961f)
                    curveTo(5.7234f, 12.5745f, 5.7938f, 12.8728f, 5.6186f, 13.048f)
                    lineTo(5.431f, 13.2357f)
                    curveTo(5.3685f, 13.2982f, 5.3333f, 13.383f, 5.3333f, 13.4714f)
                    verticalLineTo(13.9459f)
                    curveTo(5.3333f, 13.9817f, 5.3391f, 14.0173f, 5.3504f, 14.0513f)
                    lineTo(5.9563f, 15.869f)
                    curveTo(5.9843f, 15.9529f, 6.0444f, 16.0222f, 6.1235f, 16.0617f)
                    lineTo(7.1184f, 16.5592f)
                    ...
                    curveTo(8.0713f, 14.0357f, 8.0f, 13.9202f, 8.0f, 13.794f)
                    verticalLineTo(13.7602f)
                    curveTo(8.0f, 13.5434f, 8.2038f, 13.3843f, 8.4142f, 13.4369f)
                    lineTo(10.4142f, 13.9369f)
                    curveTo(10.5626f, 13.974f, 10.6667f, 14.1073f, 10.6667f, 14.2602f)
                    verticalLineTo(15.2324f)
                    curveTo(10.6667f, 15.2982f, 10.6861f, 15.3625f, 10.7226f, 15.4173f)
                    lineTo(11.901f, 17.1849f)
                    curveTo(11.9629f, 17.2776f, 12.0669f, 17.3333f, 12.1784f, 17.3333f)
                    horizontalLineTo(12.441f)
                    curveTo(12.5773f, 17.3333f, 12.6999f, 17.2503f, 12.7505f, 17.1238f)
                    lineTo(13.7243f, 14.6892f)
                    curveTo(13.8311f, 14.4221f, 14.2033f, 14.4067f, 14.332f, 14.6639f)
                    lineTo(14.6425f, 15.2849f)
                    curveTo(14.6585f, 15.317f, 14.6796f, 15.3462f, 14.7049f, 15.3716f)
                    lineTo(15.9618f, 16.6284f)
                    curveTo(15.9871f, 16.6537f, 16.0163f, 16.6748f, 16.0484f, 16.6908f)
                    lineTo(16.8509f, 17.0921f)
                    curveTo(17.0726f, 17.2029f, 17.3333f, 17.0418f, 17.3333f, 16.794f)
                    verticalLineTo(16.1381f)
                    curveTo(17.3333f, 16.0497f, 17.2982f, 15.9649f, 17.2357f, 15.9024f)
                    ...
                    curveTo(18.6397f, 14.6667f, 18.6908f, 14.6546f, 18.737f, 14.6315f)
                    lineTo(19.8157f, 14.0921f)
                    ...
                    lineTo(19.569f, 12.2357f)
                    curveTo(19.4389f, 12.1055f, 19.4389f, 11.8945f, 19.569f, 11.7643f)
                    lineTo(20.3396f, 10.9937f)
                    curveTo(20.5005f, 10.8328f, 20.7717f, 10.8768f, 20.8735f, 11.0803f)
                    lineTo(21.2509f, 11.8352f)
                    curveTo(21.3014f, 11.9362f, 21.4047f, 12.0f, 21.5176f, 12.0f)
                    curveTo(21.7392f, 12.0f, 21.8834f, 11.7667f, 21.7843f, 11.5685f)
                    lineTo(21.4824f, 10.9648f)
                    curveTo(21.4001f, 10.8001f, 21.4668f, 10.5999f, 21.6315f, 10.5176f)
                    lineTo(22.3685f, 10.1491f)
                    curveTo(22.5332f, 10.0667f, 22.5999f, 9.8665f, 22.5176f, 9.7018f)
                    lineTo(22.0617f, 8.7901f)
                    ...
                    curveTo(17.2982f, 4.0351f, 17.3333f, 3.9503f, 17.3333f, 3.8619f)
                    verticalLineTo(3.0f)
                    curveTo(17.3333f, 2.8159f, 17.1841f, 2.6667f, 17.0f, 2.6667f)
                    horizontalLineTo(14.1381f)
                    curveTo(14.0497f, 2.6667f, 13.9649f, 2.7018f, 13.9024f, 2.7643f)
                    lineTo(12.0653f, 4.6014f)
                    curveTo(12.0226f, 4.6441f, 11.969f, 4.6744f, 11.9104f, 4.6891f)
                    lineTo(9.3333f, 5.3333f)
                    lineTo(6.7863f, 5.9701f)
                    curveTo(6.7091f, 5.9894f, 6.6276f, 5.9804f, 6.5564f, 5.9448f)
                    lineTo(6.0531f, 5.6932f)
                    curveTo(5.7875f, 5.5604f, 5.4939f, 5.815f, 5.5878f, 6.0968f)
                    lineTo(5.9563f, 7.2023f)
                    curveTo(5.9843f, 7.2862f, 5.9778f, 7.3777f, 5.9383f, 7.4568f)
                    lineTo(5.4824f, 8.3685f)
                    close()
                    moveTo(14.6667f, 16.6667f)
                    curveTo(14.6667f, 17.0348f, 14.3682f, 17.3333f, 14.0f, 17.3333f)
                    curveTo(13.6318f, 17.3333f, 13.3333f, 17.0348f, 13.3333f, 16.6667f)
                    curveTo(13.3333f, 16.2985f, 13.6318f, 16.0f, 14.0f, 16.0f)
                    ...
                    curveTo(9.6318f, 9.3333f, 9.3333f, 9.6318f, 9.3333f, 10.0f)
                    curveTo(9.3333f, 10.3682f, 9.6318f, 10.6667f, 10.0f, 10.6667f)
                    close()
                    ...
                    curveTo(22.5869f, 14.6667f, 22.7023f, 14.5953f, 22.7588f, 14.4824f)
                    lineTo(23.3333f, 13.3333f)
                    lineTo(22.6667f, 12.6667f)
                    close()
                    moveTo(22.6667f, 12.6667f)
                    lineTo(23.0352f, 12.4824f)
                    curveTo(23.2755f, 12.3622f, 23.19f, 12.0f, 22.9213f, 12.0f)
