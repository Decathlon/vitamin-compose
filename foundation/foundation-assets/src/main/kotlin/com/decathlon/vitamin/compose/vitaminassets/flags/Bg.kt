...
public val FlagsGroup.Bg: ImageVector
    get() {
        if (_bg != null) {
            return _bg!!
        }
        _bg = Builder(name = "Bg", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF06A77C)), stroke = null, strokeLineWidth = 0.0f,
                ...
                path(fill = SolidColor(Color(0xFFE32E19)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = EvenOdd) {
                    moveTo(0.0f, 20.0f)
                    horizontalLineTo(28.0f)
