    ...
    get() {
        ...
        _mp = Builder(name = "Mp", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = linearGradient(0.0f to Color(0xFF1E8BD6), 1.0f to Color(0xFF1074BA),
                        start = Offset(14.0f,0.0f), end = Offset(14.0f,20.0f)), stroke = null,
                        strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(28.0f, 0.0f)
                ...
                path(fill = linearGradient(0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFFF0F0F0),
                        start = Offset(14.0f,3.33334f), end = Offset(14.0f,16.6667f)), stroke =
                        null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(14.0f, 16.6667f)
                    curveTo(17.6819f, 16.6667f, 20.6666f, 13.6819f, 20.6666f, 10.0f)
                    curveTo(20.6666f, 6.3181f, 17.6819f, 3.3333f, 14.0f, 3.3333f)
                    ...
                    curveTo(11.0545f, 15.3333f, 8.6666f, 12.9455f, 8.6666f, 10.0f)
                    curveTo(8.6666f, 7.0545f, 11.0545f, 4.6667f, 14.0f, 4.6667f)
                    curveTo(16.9455f, 4.6667f, 19.3333f, 7.0545f, 19.3333f, 10.0f)
                    curveTo(19.3333f, 12.9455f, 16.9455f, 15.3333f, 14.0f, 15.3333f)
                    close()
                }
                path(fill = linearGradient(0.0f to Color(0xFFA9A7A9), 1.0f to Color(0xFF8C8A8C),
                        start = Offset(14.0002f,6.66666f), end = Offset(14.0002f,17.3333f)), stroke
                    ...
                    curveTo(16.6297f, 16.7381f, 16.0757f, 17.3333f, 15.321f, 17.3333f)
                ...
                path(fill = linearGradient(0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFFF0F0F0),
                        start = Offset(14.0001f,6.20004f), end = Offset(14.0001f,14.6421f)), stroke
                        = null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin =
                        Miter, strokeLineMiter = 4.0f, pathFillType = EvenOdd) {
