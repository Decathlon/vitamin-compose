...
public val FlagsGroup.Ng: ImageVector
    get() {
        if (_ng != null) {
            return _ng!!
        }
        _ng = Builder(name = "Ng", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF189B62)), stroke = null, strokeLineWidth = 0.0f,
