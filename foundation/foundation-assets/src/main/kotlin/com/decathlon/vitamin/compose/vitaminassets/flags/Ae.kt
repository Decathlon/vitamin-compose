...
public val FlagsGroup.Ae: ImageVector
    get() {
        if (_ae != null) {
            return _ae!!
        }
        _ae = Builder(name = "Ae", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF12833B)), stroke = null, strokeLineWidth = 0.0f,
