...
public val FlagsGroup.Pe: ImageVector
    get() {
        if (_pe != null) {
            return _pe!!
        }
        _pe = Builder(name = "Pe", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFFE82438)), stroke = null, strokeLineWidth = 0.0f,
