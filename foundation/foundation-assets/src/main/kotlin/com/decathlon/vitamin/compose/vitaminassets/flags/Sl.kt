...
public val FlagsGroup.Sl: ImageVector
    get() {
        if (_sl != null) {
            return _sl!!
        }
        _sl = Builder(name = "Sl", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF35CE4F)), stroke = null, strokeLineWidth = 0.0f,
                ...
                path(fill = SolidColor(Color(0xFF1C87DB)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = EvenOdd) {
                    moveTo(0.0f, 20.0f)
                    horizontalLineTo(28.0f)
