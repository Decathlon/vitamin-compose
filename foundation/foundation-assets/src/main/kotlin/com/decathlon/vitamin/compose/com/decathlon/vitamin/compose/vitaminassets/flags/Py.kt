    ...
    get() {
        ...
        _py = Builder(name = "Py", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF398153)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = EvenOdd) {
                    ...
                    curveTo(11.3333f, 8.5273f, 12.5272f, 7.3333f, 14.0f, 7.3333f)
                    curveTo(15.4728f, 7.3333f, 16.6667f, 8.5273f, 16.6667f, 10.0f)
                    close()
                    moveTo(16.0f, 10.0f)
