        ...
        _xk = Builder(name = "Xk", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                path(fill = linearGradient(0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFFF0F0F0),
                        start = Offset(14.001f,0.0f), end = Offset(14.001f,20.0f)), stroke = null,
                ...
                path(fill = linearGradient(0.0f to Color(0xFF2F5FBF), 1.0f to Color(0xFF244EA3),
                        start = Offset(14.001f,0.0f), end = Offset(14.001f,20.0f)), stroke = null,
                        strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(28.001f, 0.0f)
                ...
                path(fill = linearGradient(0.0f to Color(0xFFFFFFFF), 1.0f to Color(0xFFF0F0F0),
                        start = Offset(14.0011f,3.05721f), end = Offset(14.0011f,8.94282f)), stroke
                ...
                path(fill = linearGradient(0.0f to Color(0xFFE9C072), 1.0f to Color(0xFFCFA557),
                        start = Offset(14.001f,6.66667f), end = Offset(14.001f,16.0f)), stroke =
