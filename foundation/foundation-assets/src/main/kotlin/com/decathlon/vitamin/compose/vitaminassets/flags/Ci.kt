...
public val FlagsGroup.Ci: ImageVector
    get() {
        if (_ci != null) {
            return _ci!!
        }
        _ci = Builder(name = "Ci", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF1DC87D)), stroke = null, strokeLineWidth = 0.0f,
                ...
                path(fill = SolidColor(Color(0xFFF89242)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
