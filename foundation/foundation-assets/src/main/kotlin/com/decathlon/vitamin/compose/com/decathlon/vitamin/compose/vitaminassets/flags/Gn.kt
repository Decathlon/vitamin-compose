...
public val FlagsGroup.Gn: ImageVector
    get() {
        if (_gn != null) {
            return _gn!!
        }
        _gn = Builder(name = "Gn", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFF1DBE5E)), stroke = null, strokeLineWidth = 0.0f,
                        strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                        pathFillType = NonZero) {
