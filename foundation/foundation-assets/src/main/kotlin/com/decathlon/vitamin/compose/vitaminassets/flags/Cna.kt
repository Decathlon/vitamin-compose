        ...
        _cna = Builder(name = "Cna", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFFffffff)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(9.3685f, 10.7018f, 9.3333f, 10.617f, 9.3333f, 10.5286f)
                    verticalLineTo(9.4714f)
                    curveTo(9.3333f, 9.383f, 9.2982f, 9.2982f, 9.2357f, 9.2357f)
                    lineTo(8.0653f, 8.0653f)
                    curveTo(8.0226f, 8.0226f, 7.9923f, 7.969f, 7.9776f, 7.9104f)
                    lineTo(7.3777f, 5.5108f)
                    curveTo(7.3501f, 5.4003f, 7.2679f, 5.3115f, 7.1597f, 5.2755f)
                    lineTo(5.3558f, 4.6741f)
                    curveTo(5.3408f, 4.6692f, 5.3263f, 4.6631f, 5.3122f, 4.6561f)
                    lineTo(4.1843f, 4.0921f)
                    curveTo(4.0713f, 4.0357f, 4.0f, 3.9202f, 4.0f, 3.794f)
                    verticalLineTo(3.0f)
                    curveTo(4.0f, 2.8159f, 4.1492f, 2.6667f, 4.3333f, 2.6667f)
                    ...
                    curveTo(10.6397f, 2.6667f, 10.6908f, 2.6787f, 10.737f, 2.7018f)
                    lineTo(11.9296f, 3.2981f)
                    curveTo(11.9759f, 3.3213f, 12.0269f, 3.3333f, 12.0787f, 3.3333f)
                    horizontalLineTo(13.2546f)
                    curveTo(13.3064f, 3.3333f, 13.3574f, 3.3213f, 13.4037f, 3.2981f)
                    lineTo(14.5963f, 2.7018f)
                    ...
                    curveTo(17.3333f, 3.8507f, 17.1841f, 4.0f, 17.0f, 4.0f)
                    horizontalLineTo(16.3333f)
                    curveTo(16.1492f, 4.0f, 16.0f, 4.1492f, 16.0f, 4.3333f)
                    verticalLineTo(5.794f)
                    curveTo(16.0f, 5.9202f, 16.0713f, 6.0357f, 16.1843f, 6.0921f)
                    lineTo(16.8509f, 6.4254f)
                    ...
                    curveTo(14.7464f, 12.0f, 14.631f, 12.0713f, 14.5745f, 12.1843f)
