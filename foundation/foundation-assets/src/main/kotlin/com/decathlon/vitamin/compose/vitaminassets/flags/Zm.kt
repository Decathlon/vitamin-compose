    ...
    get() {
        ...
        _zm = Builder(name = "Zm", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = linearGradient(0.0f to Color(0xFF2A8815), 1.0f to Color(0xFF35A51D),
                        start = Offset(13.999f,20.0f), end = Offset(13.999f,0.0f)), stroke = null,
                        strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(27.999f, 0.0f)
                    horizontalLineTo(-0.001f)
                ...
                path(fill = linearGradient(0.0f to Color(0xFFEF8A34), 1.0f to Color(0xFFEC7E21),
                        start = Offset(22.0974f,1.90022f), end = Offset(22.0974f,6.18482f)), stroke
                    ...
                    curveTo(20.025f, 4.6696f, 19.5657f, 4.1205f, 19.1884f, 3.9298f)
                    ...
                    curveTo(21.9494f, 2.031f, 22.0866f, 1.8619f, 22.3899f, 1.9078f)
                    ...
                    curveTo(22.5125f, 6.11f, 22.3985f, 6.221f, 21.9987f, 6.1739f)
                ...
                path(fill = linearGradient(0.0f to Color(0xFFF48D36), 1.0f to Color(0xFFEC7E21),
                        start = Offset(25.999f,8.0f), end = Offset(25.999f,20.0f)), stroke = null,
                        strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(27.999f, 8.0f)
                ...
                path(fill = linearGradient(0.0f to Color(0xFF262626), 1.0f to Color(0xFF0D0D0D),
                        start = Offset(21.999f,8.0f), end = Offset(21.999f,20.0f)), stroke = null,
                        strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(23.999f, 8.0f)
                ...
                path(fill = linearGradient(0.0f to Color(0xFFEC322B), 1.0f to Color(0xFFDB261F),
                        start = Offset(17.999f,8.0f), end = Offset(17.999f,20.0f)), stroke = null,
                        strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                        strokeLineMiter = 4.0f, pathFillType = NonZero) {
                    moveTo(19.999f, 8.0f)
