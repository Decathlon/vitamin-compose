        ...
        _mo = Builder(name = "Mo", defaultWidth = 28.0.dp, defaultHeight = 20.0.dp, viewportWidth =
            ...
            group {
                ...
                path(fill = SolidColor(Color(0xFFffffff)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(15.8849f, 8.9585f, 15.8637f, 9.2416f, 15.8238f, 9.5114f)
                    curveTo(15.9261f, 9.48f, 16.0302f, 9.45f, 16.1361f, 9.4216f)
                    curveTo(17.9143f, 8.9452f, 19.5015f, 9.1024f, 19.6811f, 9.7728f)
                    curveTo(19.8435f, 10.3787f, 18.8006f, 11.1963f, 17.2858f, 11.6998f)
                    ...
                    curveTo(8.5351f, 9.1177f, 10.1223f, 8.9605f, 11.9005f, 9.4369f)
                    curveTo(11.9939f, 9.462f, 12.0859f, 9.4882f, 12.1765f, 9.5156f)
                    curveTo(12.1362f, 9.2446f, 12.1148f, 8.9601f, 12.1148f, 8.6667f)
                    curveTo(12.1148f, 6.8257f, 12.9587f, 5.3333f, 13.9998f, 5.3333f)
                    curveTo(15.0409f, 5.3333f, 15.8849f, 6.8257f, 15.8849f, 8.6667f)
                    close()
                    moveTo(10.6665f, 12.0f)
                    lineTo(11.833f, 12.0f)
                    curveTo(11.6482f, 11.9638f, 11.4597f, 11.9204f, 11.2689f, 11.8697f)
                    ...
                    lineTo(17.3332f, 12.0f)
                    lineTo(19.3332f, 12.0f)
                    curveTo(19.175f, 12.4747f, 18.9622f, 12.922f, 18.7027f, 13.3333f)
                    horizontalLineTo(9.297f)
                    curveTo(9.0375f, 12.922f, 8.8246f, 12.4747f, 8.6665f, 12.0f)
                    lineTo(10.6665f, 12.0f)
                    close()
                ...
                path(fill = SolidColor(Color(0xFFFCD117)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(14.6668f, 2.9651f, 14.3684f, 2.6667f, 14.0002f, 2.6667f)
                    curveTo(13.632f, 2.6667f, 13.3335f, 2.9651f, 13.3335f, 3.3333f)
                    ...
                    curveTo(18.6665f, 6.2984f, 18.965f, 6.0f, 19.3332f, 6.0f)
                    curveTo(19.7014f, 6.0f, 19.9998f, 6.2984f, 19.9998f, 6.6666f)
                    close()
                    moveTo(17.3332f, 5.3333f)
                    curveTo(17.7014f, 5.3333f, 17.9998f, 5.0348f, 17.9998f, 4.6666f)
                    curveTo(17.9998f, 4.2984f, 17.7014f, 4.0f, 17.3332f, 4.0f)
                    curveTo(16.965f, 4.0f, 16.6665f, 4.2984f, 16.6665f, 4.6666f)
