  ...
  override fun Screen() {
    SampleScaffold(title = name) {
      LazyColumn(modifier = Modifier.fillMaxSize()) {
        ...
        item {
          SampleRow(firstItem = true, color = VitaminTheme.colors.vtmnBackgroundBrandPrimary) {
        ...
        item {
          SampleRow(lastItem = true, color = VitaminTheme.colors.vtmnBackgroundBrandPrimary) {
